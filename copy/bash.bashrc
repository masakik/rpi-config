...
# setup fancy prompt
export PS1='`exitStatus=$?;if [ $fs_mode = "ro" ];then echo "\[\033[01;32m\]\u@\h${fs_mode:+($fs_mode)}\[\033[00m\]";else echo "\[\033[01;31m\]\u@\h${fs_
mode:+($fs_mode)}\[\033[00m\]";fi`:\[\033[01;34m\]\w\[\033[00m\]\$ '
#end_configure
